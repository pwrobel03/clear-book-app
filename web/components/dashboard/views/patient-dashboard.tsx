  ...
  return (
    <GlassCard className="p-6">
      <div className="flex items-center gap-4">
        <div
          className={`flex h-12 w-12 items-center justify-center rounded-2xl shadow-inner ${iconColor}`}
        >
          <Icon size={22} />
        </div>
...
function UpcomingRow({ appt }: { appt: AppointmentResponse }) {
  ...
  return (
    ...
    >
      {/* Avatar / icon */}
      <div
        className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ${isReserved ? "bg-amber-500/10" : "bg-primary/10"}`}
      >
        <Stethoscope
          size={16}
          className={
            isReserved ? "text-amber-600 dark:text-amber-400" : "text-primary"
          }
        />
      </div>
      ...
      <div className="text-right shrink-0">
        <p
          className={`text-sm font-bold ${isReserved ? "text-amber-600 dark:text-amber-400" : "text-foreground"}`}
        >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-0.5">
                        Dr. {lastVisit.doctorFirstName}{" "}
                        {lastVisit.doctorLastName}
                      </p>
                    </div>
                  </div>
